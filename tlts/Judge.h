...
void	ParseScrewHole(F_HEAD& head, BlockData_A& DataA, vector<BlockData_B>& blocks, VCR* vCRs, CR& cr, int iCrIndex, uint8_t iFRow, bool carType, uint8_t railType, vector<Wound_Judged>& vWounds);
